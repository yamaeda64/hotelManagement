...
public class MainMenuController{
    ...
    @FXML
    private MenuItem menu_new_booking;

    @FXML
    private MenuItem menu_find_existing;
    ...
    @FXML
    private CheckMenuItem menu_växjö;

    @FXML
    private CheckMenuItem menu_kalmar;

    @FXML
    private Button new_booking_button;

    @FXML
    private Button find_existing_button;

    @FXML
    private Text sheet_text;
